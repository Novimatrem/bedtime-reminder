...
echo.
mklink "C:\Program Files\Git\bedtime-reminder.sh" "C:\Users\%username%\bedtime-reminder.sh"
echo.
echo ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.\wt.exe wt.exe "C:\Program Files\Git\git-bash.exe" --hide -c "bash ../bedtime-reminder.sh"
cd /D "%~dp0"
